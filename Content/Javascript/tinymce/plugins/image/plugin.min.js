...
tinymce.PluginManager.add('image', function (editor) {
    ...
    function showDialog(imageList) {
        ...
        var generalFormItems = [
            { name: 'filemanager', type: 'button', text: 'File Manager', onClick: function () {
                var src = win.find('#src')[0];
                var obj = document.getElementById(src._id + "-inp");
                window.open('/Admin/FileManager/?sourceInputId=' + src._id + '-inp', '', 'width=800,height=570,toolbar=no,status=no,menubar=no,scrollbars=no,resizable=no');
            }
            },
